...
```
<img src="https://user-images.githubusercontent.com/29790334/139807317-a420f121-da39-4ad8-afda-8dee4adcc989.png" width="300"/>

```
- 라즈베리파이는 Analog 신호를 받지 못하기 때문에 ADC Converter를 통해 Digital 신호로 변화하는 장치가 필요하다.
- ADC Converter는 sparkfun의 ADS1015를 사용했다.
```
<img src="https://user-images.githubusercontent.com/29790334/139806416-8eba805a-749e-4bb8-b230-b59d6a116ab6.png" width="300"/>
```
